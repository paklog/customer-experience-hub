# ============================================
# Multi-stage Dockerfile for Customer Experience Hub
...
LABEL org.opencontainers.image.title="Customer Experience Hub" \
      org.opencontainers.image.description="Order tracking and customer self-service portal" \
      org.opencontainers.image.version="${APP_VERSION}" \
      org.opencontainers.image.vendor="Paklog" \
      org.opencontainers.image.authors="Paklog Engineering Team" \
      org.opencontainers.image.source="https://github.com/paklog/customer-experience-hub" \
